...
@section('content')
    <input id="account_type" type="hidden" value="entity">
    <input id="account_id" type="hidden" value="{{ session()->get('entity')->id }}">
        ...
        <div class="row">
            ...
            <div class="col-6 small">
                ...
                <div class="d-flex flex-row align-items-center">
                    ...
                    <span class="ml-1 "> {{ session()->get('entity')->phone  }}</span>
                </div>
                <div class="d-flex flex-row align-items-center">
